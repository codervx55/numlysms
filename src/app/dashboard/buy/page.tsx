          ...
          {PLATFORMS.map((p) => {
            ...
            return (
              <button
                ...
                className={`press-scale flex items-center gap-2 pl-2 pr-3 py-2 rounded-full border text-sm transition-all ${
                  active
            ...
            <div className="space-y-2">
              ...
              {visibleServices?.map((s) => (
                <button
                  ...
                  className={`w-full panel interactive-lift flex items-center justify-between p-4 text-left transition-colors ${
